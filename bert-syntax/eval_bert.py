...
#bert=CamembertForMaskedLM.from_pretrained(model_name)
...
def get_probs_for_words(sent,w1,w2):
    ...
    try:
        ...
        #word_ids=[tokenizer._convert_token_to_id(w1), \
        #          tokenizer._convert_token_to_id(w2)]
        #if word_ids[0] == 4 or word_ids[1] == 4:
...
def load_marvin():
    ...
    out = []
    for line in open("/export/c02/amueller/clams/ru_replication_evalset/forbert.tsv"):
