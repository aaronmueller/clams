#!/bin/bash
#SBATCH --job-name=train_lm_de.$SLURM_JOBID
...
#SBATCH --output=/home-1/amuelle8@jhu.edu/logs/out-lstm-de.$SLURM_JOBID.log
#SBATCH --error=/home-1/amuelle8@jhu.edu/logs/err-lstm-de.$SLURM_JOBID.log
#SBATCH --workdir=/home-1/amuelle8@jhu.edu/scratch/workdir/de.$SLURM_JOBID
...
source /home-1/amuelle8@jhu.edu/scratch/LM_syneval/hyperparameters_de.txt
