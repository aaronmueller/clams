#!/bin/bash
#SBATCH --job-name=train_lm_ru.$SLURM_JOBID
...
#SBATCH --output=/home-1/amuelle8@jhu.edu/logs/out-lstm-ru.$SLURM_JOBID.log
#SBATCH --error=/home-1/amuelle8@jhu.edu/logs/err-lstm-ru.$SLURM_JOBID.log
#SBATCH --workdir=/home-1/amuelle8@jhu.edu/scratch/workdir/ru.$SLURM_JOBID
...
source /home-1/amuelle8@jhu.edu/scratch/LM_syneval/hyperparameters_ru.txt
