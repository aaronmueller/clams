#!/bin/bash
#SBATCH --job-name=train_lm_he.$SLURM_JOBID
...
#SBATCH --output=/home-1/amuelle8@jhu.edu/logs/out-train-he.$SLURM_JOBID.log
#SBATCH --error=/home-1/amuelle8@jhu.edu/logs/err-lstm-he.$SLURM_JOBID.log
#SBATCH --workdir=/home-1/amuelle8@jhu.edu/scratch/workdir/he.$SLURM_JOBID
...
source /home-1/amuelle8@jhu.edu/scratch/LM_syneval/hyperparameters_he.txt
